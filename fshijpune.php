    ...
    <section id="content" class="box">
        ...
        <form id="puna" method="POST">
            ...
            <input type="hidden" id="punaid" name="punaid" value="<?php if(!empty($punaid)) echo $punaid; ?>">
                ...
                <select disabled id='projektiid' name="projektiid">
                    <?php
            ...
            <fieldset>
                ...
                <input disabled type="date" id="datapune" name="datapune"
                value="<?php if(!empty($datapune)) echo $datapune; ?>">
            </fieldset>
            <fieldset>
                <label>Pershkrimi: </label>
                <textarea disabled id="pershkrimi" name="pershkrimi">
